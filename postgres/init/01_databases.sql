...
-- Industry databases (grocery, etc.) each contain raw_*, staging, mart schemas.
-- The grocery_ingest_api DAG creates raw_* schemas on first load; dbt creates staging + mart on first run.
